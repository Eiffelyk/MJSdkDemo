...
|2018年11月27日|mjsdk:1.0.29<br>mjthinkkey:1.0.1<br>mjspeech:1.0.1|1.添加授权自动续约，解决授权到期后需要重新初始化的问题<br>2.混淆SDK代码<br>3.加密网络数据交互（有效防止抓包，等中间人攻击）<br>4.初始化更灵活，添加了一种初始化的时候调用license文件的方式|
## **使用步骤：**
